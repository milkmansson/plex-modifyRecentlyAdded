...
* Plex Python library: 
### Prerequisites
- Get yourself python installed.  You will need to install python Plex API.  Follow these instructions https://python-plexapi.readthedocs.io/en/latest/introduction.html
### To make it work
